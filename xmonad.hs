...
myStartupHook = do
    ...
    spawnOnce "~/.fehbg" 
    --spawnOnce "$HOME/scripts/set_random_wallpaper.sh"
    
    -- eww
    spawnOnce "eww daemon"
    spawnOnce "$HOME/.config/eww/bar/launch.sh --open-all"
    spawnOnce "$HOME/.config/eww/popup/launch.sh --open-all" 
...
myKeys conf@(XConfig {XMonad.modMask = super}) = M.fromList $
    [ 
        ...
        -- Take screenshot
        ((super, xK_s),
            spawn "$HOME/scripts/screenshot.sh --full"),
       
        -- Take selected area 
        ((super .|. shiftMask, xK_s),
            spawn "$HOME/scripts/screenshot.sh --select"),
        ...
        ((super, xK_w),
            spawn "$HOME/scripts/set_random_wallpaper.sh"),
